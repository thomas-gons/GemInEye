...
<body>
    ...
    <main>
        ...
        <div id="page-content">
            <div id="container">
                <h1 class="title">Privacy Policy for Gem In Eye</h1>
                <div class="paragraph">
                    <p>At Gem In Eye, accessible from https://www.gemineye.com, one of our main priorities is the privacy of our
                        visitors. This Privacy Policy document contains types of information that is collected and recorded by Gem
                        In Eye and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                        regards to the information that they shared and/or collect in Gem In Eye. This policy is not applicable to
                        any information collected offline or via channels other than this website. Our Privacy Policy was created
                        with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/">Free Privacy Policy
                            Generator</a>.</p>
                </div>
                <hr class="lign">
                <div id="consent" class="paragraph">
                    <h1 class="title">Consent</h2>
                    <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
                </div>
                <hr class="lign">
                <div id="collect" class="paragraph">
                    <h1 class="title">Information we collect</h2>
                ...
                <hr class="lign">
                <div id="information-use" class="paragraph">
                    <h1 class="title">How we use your information</h2>
                ...
                <hr class="lign">
                <div id="log" class="paragraph">
                    <h1 class="title">Log Files</h2>
                    <p>Gem In Eye follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <hr class="lign">
                <div id="partner" class="paragraph">
                    <h1 class="title">Advertising Partners Privacy Policies</h2>
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Gem In Eye.</p>
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                        used in their respective advertisements and links that appear on Gem In Eye, which are sent directly to
                    ...
                    <p>Note that Gem In Eye has no access to or control over these cookies that are used by third-party advertisers.</p>
                </div>
                <hr class="lign">
                <div id="third-party" class="paragraph">
                    <h1 class="title">Third Party Privacy Policies</h2>
                    <p>Gem In Eye's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                ...
                <hr class="lign">
                <div id="ccpa-privacy-rights" class="paragraph">
                    <h1 class="title">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                ...
                <hr class="lign">
                <div id="gdrp-data-protection-rights" class="paragraph">
                    <h1 class="title">GDPR Data Protection Rights</h2>
                ...
                <hr class="lign">
                <div id="children-information" class="paragraph">
                    <h1 class="title">Children's Information</h2>
                    ...
                    <p>Gem In Eye does not knowingly collect any Personal Identifiable Information from children under the age of
